...
/*
 * Allwinner V536 (sun8iw16) SoC PIO pinctrl driver.
 *
 * Pin tables taken from the Allwinner BSP 4.9 driver
 * pinctrl-sun8iw16p1.c (Copyright (C) 2016-2020 Allwinnertech).
 */
...
static const struct sunxi_desc_pin sun8i_v536_pins[] = {
	/* hole */
...
/* Interrupt-capable banks are PC..PI; EINT registers are indexed by the
 * absolute bank number, like in the vendor driver. */
static const unsigned int sun8i_v536_irq_bank_map[] = { 2, 3, 4, 5, 6, 7, 8 };

static const struct sunxi_pinctrl_desc sun8i_v536_pinctrl_data = {
	.pins = sun8i_v536_pins,
	.npins = ARRAY_SIZE(sun8i_v536_pins),
	.irq_banks = ARRAY_SIZE(sun8i_v536_irq_bank_map),
	.irq_bank_map = sun8i_v536_irq_bank_map,
	.irq_read_needs_mux = true,
};

static int sun8i_v536_pinctrl_probe(struct platform_device *pdev)
{
	return sunxi_pinctrl_init(pdev, &sun8i_v536_pinctrl_data);
}

static const struct of_device_id sun8i_v536_pinctrl_match[] = {
	{ .compatible = "allwinner,sun8i-v536-pinctrl", },
	{ },
};

static struct platform_driver sun8i_v536_pinctrl_driver = {
	.probe	= sun8i_v536_pinctrl_probe,
	.driver	= {
		.name		= "sun8i-v536-pinctrl",
		.of_match_table	= sun8i_v536_pinctrl_match,
	},
};
builtin_platform_driver(sun8i_v536_pinctrl_driver);
