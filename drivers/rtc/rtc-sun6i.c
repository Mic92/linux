...
static void __init sun8i_v536_rtc_clk_init(struct device_node *node)
{
	sun6i_rtc_clk_init(node, &sun50i_h6_rtc_data);
}
CLK_OF_DECLARE_DRIVER(sun8i_v536_rtc_clk, "allwinner,sun8i-v536-rtc",
		      sun8i_v536_rtc_clk_init);
...
static const struct of_device_id sun6i_rtc_dt_ids[] = {
	...
	{ .compatible = "allwinner,sun8i-v536-rtc" },
